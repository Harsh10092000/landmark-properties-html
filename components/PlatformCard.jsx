...
const PlatformIcon = ({ platform }) => {
    const icons = {
        ...
        trustpilot: (
            <svg className="platform-icon" viewBox="0 0 24 24" fill="#00B67A">
                <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
            </svg>
        ),
        facebook: (
            <svg className="platform-icon" viewBox="0 0 24 24" fill="#1877F2">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
            </svg>
        ),
        instagram: (
            <svg className="platform-icon" viewBox="0 0 24 24" fill="#E1306C">
    ...
    return icons[platform] || (
        <svg className="platform-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    return (
        <div className="platform-card">
            ...
            <div className="platform-header">
                ...
                {/* Write Review Button - Uses platform brand color */}
                <a
                    href={platform.reviewUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="platform-write-btn"
                    style={{
                        backgroundColor: platform.colors?.primary || "#16A34A",
                        boxShadow: `0 4px 12px ${platform.colors?.primary || "#16A34A"}40`
                    }}
                >
            ...
            <div className="reviews-grid">
                {visibleReviews.map((review) => (
                    <ReviewCard
                        ...
                        redirectUrl={platform.reviewUrl}
                    />
                ))}
            </div>
            ...
            {showViewMore && hasMoreReviews && (
                <div className="view-more-wrapper">
                    <button
                        ...
                        style={{ color: platform.colors?.primary || "#16A34A" }}
                    >
                        {expanded ? (
                            <>
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">

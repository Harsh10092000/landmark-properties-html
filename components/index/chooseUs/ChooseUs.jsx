...
const ChooseUs = () => {
  return (
    <section className="contact__property--section section--padding color-accent-2">
            <div className="container">
                <div className="section__heading text-center mb-50 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
                    ...
                    <div className="contact__property--form">
                        <form action="#">
                            ...
                            <div className="contact__property--form__inner">
                                ...
                                <button className="contact__property--btn solid__btn" type="submit">Send Messege</button>
                            </div>
                        </form>
                    </div>
                </div>

          ...
          <div className="container max-w-1430">
            <div className="main__header d-flex justify-content-between align-items-center">
              <div className="offcanvas__header--menu__open ">
                <a
                  className="offcanvas__header--menu__open--btn style4"
                ...
                <div className="header__account d-flex align-items-center">
                  ...
                  <ul className="header__account--icon d-flex">
                    <li className="header__account--icon__list">
                      <a className="header__account--icon__link" href="login.html">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                          height="24"
                    ...
                    <li className="header__account--icon__list">
                      <a
                        className="header__account--icon__link search__open--btn"
                        href="javascript:void(0)"
                        data-offcanvas
                      >
                        <svg
        ...
        <div className="offcanvas__inner">
            ...
            <nav className="offcanvas__menu">
                <ul className="offcanvas__menu_ul">
                    ...
                    <li className="offcanvas__menu_li">
                        <a className="offcanvas__menu_item" href="listing.html">Listing</a>
                        <ul className="offcanvas__sub_menu">
                            <li className="offcanvas__sub_menu_li"><a href="listing.html" className="offcanvas__sub_menu_item">Listing Left Sidebar</a></li>
                            <li className="offcanvas__sub_menu_li"><a href="listing-right-sidebar.html" className="offcanvas__sub_menu_item">Listing Right Sidebar</a></li>
                            <li className="offcanvas__sub_menu_li"><a href="listing.html" className="offcanvas__sub_menu_item">Listing Grig</a></li>
                            <li className="offcanvas__sub_menu_li"><a href="listing-list.html" className="offcanvas__sub_menu_item">Listing List</a></li>
                            <li className="offcanvas__sub_menu_li"><a href="listing-details.html" className="offcanvas__sub_menu_item">Listing Details</a></li>
                        </ul>
                    </li>
                    
                    <li className="offcanvas__menu_li"><a className="offcanvas__menu_item" href="admin/my-properties.html">Properties</a></li>
                   
                    <li className="offcanvas__menu_li"><a className="offcanvas__menu_item" href="blog.html">About Us</a></li>
                    <li className="offcanvas__menu_li"><a className="offcanvas__menu_item" href="blog.html">Sale</a></li>
                    <li className="offcanvas__menu_li"><a className="offcanvas__menu_item" href="blog.html">Rent</a></li>
                    <li className="offcanvas__menu_li"><a className="offcanvas__menu_item" href="blog.html">Contact Us</a></li>
                </ul>
            </nav>
            <a className="add__listing--btn offcanvas__listing--btn solid__btn" href="admin/create-listing.html"><span>Add Listing</span> <svg width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="side__menu--footer mobile__menu--footer">
                <div className="side__menu--info">
                    <div className="side__menu--info__list">
                        <h3 className="side__menu--info__title">Customer Care Phone</h3>
                        <p><a className="side__menu--info__text" href="tel:+9996716787">: +91 99967 16787, +91 90500 48884</a></p>
                    </div>
                    <div className="side__menu--info__list">
                        <h3 className="side__menu--info__title">Need Live Support?</h3>
                        <p><a className="side__menu--info__text" href="mailto:propertieslandmark07@gmail.com">propertieslandmark07@gmail.com</a></p>
                    </div>
                </div>
                <div className="side__menu--share d-flex align-items-center">
                    <h3 className="side__menu--share__title">Follow us :</h3>
                    <ul className=" side__menu--share__wrapper d-flex align-items-center">
                        <li className="side__menu--share__list">
                            <a className="side__menu--share__icon" target="_blank" href="https://www.facebook.com/">
                        ...
                        <li className="side__menu--share__list">
                            <a className="side__menu--share__icon" target="_blank" href="https://twitter.com/">
                        ...
                        <li className="side__menu--share__list">
                            <a className="side__menu--share__icon" target="_blank" href="https://www.instagram.com/">
                        ...
                        <li className="side__menu--share__list">
                            <a className="side__menu--share__icon" target="_blank" href="https://www.pinterest.com/">

          ...
          <div className="container max-w-1430">
            <div className="main__header d-flex justify-content-between align-items-center">
              <div className="offcanvas__header--menu__open">
                <Link className="offcanvas__header--menu__open--btn style4" href="javascript:void(0)" data-offcanvas>
          ...
          <div className="side__menu--footer mobile__menu--footer">
            <div className="side__menu--info">
              <div className="side__menu--info__list">
                ...
                <p><Link className="side__menu--info__text" href="tel:+9996716787">: +91 99967 16787, +91 90500 48884</Link></p>
              </div>
              <div className="side__menu--info__list">
                <h3 className="side__menu--info__title">Need Live Support?</h3>
                <p><Link className="side__menu--info__text" href="mailto:propertieslandmark07@gmail.com">propertieslandmark07@gmail.com</Link></p>
              </div>
            </div>
            <div className="side__menu--share d-flex align-items-center">
              ...
              <ul className="side__menu--share__wrapper d-flex align-items-center">
                {socialLinks.map((link) => (
                  <li key={link.id} className="side__menu--share__list">
                    <Link className="side__menu--share__icon" target="_blank" href={link.href}>
                      {link.icon}

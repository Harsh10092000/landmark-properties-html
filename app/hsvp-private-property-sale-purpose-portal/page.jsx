...
const Page = () => {
    return (
                    ...
                    <div className="row g-4 ">
                        <div className="col-lg-8">
                            <article className="hsvp-heroCard">
                                ...
                                <p className="hsvp-lead">Haryana Shehri Vikas Pradhikaran (HSVP) ne private properties ki sale–purchase ke liye ek transparent, digital aur compliant portal launch kiya hai. Neeche aapko policy PDF, highlights aur seller journey ka quick guide milega.</p>
        ...
        .hsvp-chip{padding:16px 18px;border:1px dashed #cbd5e1;border-radius:14px;background:#fff;min-height:60px;display:flex;align-items:center}
        ...
        .hsvp-feature{display:flex;align-items:center;gap:10px;border:1px solid #e2e8f0;border-radius:16px;padding:14px 16px;background:#fff;box-shadow:0 6px 22px rgba(2,6,23,.06)}
        .hsvp-feature-ico{font-size:20px}
        .hsvp-feature-title{font-weight:700}

...
export async function generateMetadata() {
  ...
  let desc = "Commercial properties in Kurukshetra & Haryana — retail shops, offices, warehouses. Business-ready locations, verified listings and competitive rates.";
  let capitalizedName1 = "Commercial Properties in Kurukshetra & Haryana | Shops, Offices & Warehouses";
  
  const schema = {
    "@context": "https://schema.org",
    "@type": "RealEstateListing",
    name: capitalizedName1,
    url: `https://landmarkplots.com/commercial-properties`,
  ...
  return {
    ...
    alternates: {
      canonical: `https://landmarkplots.com/commercial-properties`,
    },
    other: {
...
const getData = async () => {
  try {
    const db = await pool;
    const q = `SELECT * FROM property_module where pro_listed = 1 and pro_type = 'Commercial' ORDER BY pro_id DESC`;
    const q1 =
...
const page = async ({searchParams}) => {
  ...
  return (
    <div className="container">
      <title>Properties for Commercial Properties | 1-4 BHK Shops, Offices, Warehouses | Zero Brokerage | Immediate Possession Available!</title>
      <meta name="description" content="Properties for Commercial Properties | 1-4 BHK Shops, Offices, Warehouses | Zero Brokerage | Immediate Possession Available!" />
      <meta name="keywords" content="Properties for Commercial Properties, 1-4 BHK Shops, Offices, Warehouses, Zero Brokerage, Immediate Possession Available!" />
      <meta name="author" content="Landmark Plots" />
      <meta name="robots" content="index, follow" />
      <link rel="canonical" href="https://landmarkplots.com/commercial-properties" />
      
      {/* Open Graph Tags */}
      <meta property="og:title" content="Properties for Commercial Properties | 1-4 BHK Shops, Offices, Warehouses | Zero Brokerage | Immediate Possession Available!" />
      ...
      <meta property="og:url" content="https://landmarkplots.com/commercial-properties" />
      ...
      <meta name="twitter:title" content="Properties for Commercial Properties | 1-4 BHK Shops, Offices, Warehouses | Zero Brokerage | Immediate Possession Available!" />
      <meta name="twitter:description" content="Properties for Commercial Properties | 1-4 BHK Shops, Offices, Warehouses | Zero Brokerage | Immediate Possession Available!" />

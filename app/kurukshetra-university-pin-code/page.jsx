...
export const generateMetadata = () => ({
  title: "Kurukshetra University PIN Code 136119 - Campus & Nearby | Landmark Plots",
  description:
    "Kurukshetra University (KUK) PIN code is 136119. See campus and nearby areas in Kurukshetra, Haryana with postal details useful for address, courier and property assistance.",
  keywords: [
  ...
  twitter: {
    ...
    title: "Kurukshetra University PIN 136119 - Postal Details",
    description: "KUK Sub Office PIN 136119 with delivery status, taluk, division and helpline.",
  },

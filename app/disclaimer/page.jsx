...
const Disclaimer = () => {
  return (
    <>
    <title>Landmark Plots - Disclaimer</title>
    <meta name="description" content="Disclaimer for Landmark Plots - Real Estate" />
    <meta name="keywords" content="Landmark Plots, Disclaimer, Real Estate" />

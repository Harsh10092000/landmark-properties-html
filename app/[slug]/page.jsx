...
const getData = async (slug, proId) => {
  try {
    ...
    const q2 = `SELECT pro_ad_type, pro_amt, pro_locality, pro_washrooms, pro_bedroom, pro_area_size , pro_area_size_unit, pro_user_id, pro_user_type, pro_url, listing_id, pro_type, pro_city, pro_state, pro_cover_image, pro_other_images, pro_creation_date, pro_views FROM property_module where pro_listed = 1 ORDER BY pro_id DESC limit 6`;
    const [latestProperty] = await db.query(q2);

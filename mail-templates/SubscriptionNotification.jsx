...
export const SubscriptionNotificationEmail = ({
  ...
  <Html>
    <Head />
    <Preview>New Newsletter Subscription - {subscriberEmail}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <div style={contentSection}>
          <Text style={text}>
            A new user has subscribed to your property newsletter!
          </Text>
          ...
          <Text style={text}>
            This subscriber will now receive notifications about new properties added to your platform.
          </Text>
